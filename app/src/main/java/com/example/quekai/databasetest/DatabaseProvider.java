...
public class DatabaseProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.example.quekai.databasetest.provider";
    ...
    public String getType(Uri uri) {
        ...
        switch (uriMatcher.match(uri)){
            case BOOK_DIR:
                return "vnd.android.cursor.dir/vnd.com.example.quekai.databasetest.provider.book";
            case BOOK_ITEM:
                return "vnd.android.cursor.item/vnd.com.example.quekai.databasetest.provider.book";
            case CATEGORY_DIR:
                return "vnd.android.cursor.dir/vnd.com.example.quekai.databasetest.provider.category";
            case CATEGORY_ITEM:
                return "vnd.android.cursor.item/vnd.com.example.quekai.databasetest.provider.category";
        }
        return null;
    }
